    ...
    const fetchData = async () => {
      await execute(
        async () => {
          ...
          showSuccess(`Datos fundamentales de ${ticker} cargados exitosamente`);
        },
        `Cargando datos fundamentales de ${ticker}...`
      );
    };
    ...
    return (
      <BaseLayout>
        <div className="flex justify-center items-center h-screen bg-black">
          <div className="text-white text-lg">Cargando datos fundamentales...</div>
        </div>
      </BaseLayout>
    );
  }
